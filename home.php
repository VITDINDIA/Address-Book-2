...
<div class="container">    
  ...
  <input type="text" name="fname" value="<?php echo"$GetData[0]";	?>" class="form-control" >
   </div>
   <div class="form-group">
  <label for="usr">Last Name:</label>
  <input type="text" name="lname" value="<?php echo"$GetData[1]";	?>" class="form-control" >
   </div>
   <div class="form-group">
   <center><button type="submit" name="submit" value="Update" class="btn btn-default">Update</button></center>
  </div>
  </form>
						</div>
<?php	include('update.php');	?>
   ...
   <div class="navbar navbar-default navbar-fixed-bottom">
    <div class="container">
      ...
      <a href="http://youtu.be/" class="navbar-btn btn-danger btn pull-right">
